                ...
                <form>
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4><span class="glyphicon glyphicon-pencil"></span> Editar Cliente</h4>
                        </div>
                                ...
                                if($result->num_rows > 0) {
                                    if($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<div class='form-group'>
                                                <label>DPI</label><input id='dpi' class='form-control' type='text' value='".$row["dpi"]."'></div>";
                                        echo "<div class='form-group'>
                                                <label>Nombre</label><input id='nombre' class='form-control' type='text' value='".$row["nombre"]."'></div>";
                                    }
                                }
                                else {
                                    echo "0 Resultados";
                        ...
                        <div class="panel-footer">
                            <button id="btnEliminar" class="btn btn-warning" type="button"><span class="glyphicon glyphicon-pencil"></span> Editar</button>
